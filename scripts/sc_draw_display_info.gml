///sc_draw_display_info(display enum)
...
switch(argument[0])
{
  ...
  break;
  case display.view:
    str="View: "+string(view_wview)+" x "+string(view_hview)+" ("+string(view_wview/view_hview)+")# Coord X: " + string(view_xview) + " & Y: " + string(view_yview);
 break;
}
return str;
